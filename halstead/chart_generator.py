...
class ChartGenerator:
    ...
    def generate(res, output_dir):
        """
        Generate chart and return base64 encoded image for HTML embedding.
        ...
        Returns:
            Tuple of (chart_filename, base64_encoded_image) or (None, None) if matplotlib unavailable
        """
        ...
        plt.close()
        return chart_filename, None  # Return filename, base64 no longer needed
